...
class Generator(object):
    ...
    def __init__(self):
        ...
        with open("/home/lidanzha/data/lane/culane/list/train.txt") as f:
        ...
        # load test set
        self.test_data = []
        with open("/home/lidanzha/data/lane/culane/list/test.txt") as f:
    ...
    def Resize_data(self, start, end, sampling_list):
        ...
        for i in range(start, end):
            ...
            if sampling_list == None:
                ...
                choose = secretsGenerator.random()#random.random()
                if choose > 0.2:
                    data = random.sample(self.train_data, 1)[0]
                    data_list.append(data)
                else:
            ...
            # train set image
            #print(self.p.train_root_url+data[1:-1])
        ...
        test_index = secretsGenerator.randrange(0, self.size_test-1)
    ...
    def Change_intensity(self):
        ...
        for i in indices:
            ...
            value = int(secretsGenerator.uniform(-60.0, 60.0))
            if value > 0:
                lim = 255 - value
                v[v > lim] = 255
                v[v <= lim] += value
    ...
    def Shadow(self, min_alpha=0.5, max_alpha = 0.75):
        ...
        for i in indices:
            ...
            top_x = secretsGenerator.randint(0,512)
            bottom_x = secretsGenerator.randint(0,512)
            coin = 0
            rows, cols, _ = test_image.shape
            shadow_img = test_image.copy()
            if coin == 0:
                #rand = np.random.randint(2)
                rand = secretsGenerator.randint(0,2)
                ...
                rand_alpha = secretsGenerator.uniform(min_alpha, max_alpha)
    ...
    def Translation(self):
        ...
        for i in indices:
            ...
            tx = secretsGenerator.randint(-50,50)
            ty = secretsGenerator.randint(-30,30)
    ...
    def Rotate(self):
        ...
        for i in indices:
            ...
            angle = secretsGenerator.randint(-10,10)
