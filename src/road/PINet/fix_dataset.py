...
class Generator(object):
    ...
    def __init__(self):
        ...
        self.train_data = []
        self.test_data = []
        filer = os.path.join(self.p.train_root_url,'label_data_0313.json')
        ...
        filename = os.path.join(self.p.train_root_url,'label_data_0531.json')
        ...
        random.shuffle(self.train_data)
        filename = os.path.join(self.p.train_root_url,'label_data_0601.json')
        with open(filename) as f:
            while True:
                line = f.readline()
                if not line:
        ...
        filename = os.path.join(self.p.test_root_url,'test_label.json')
