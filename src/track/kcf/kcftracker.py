...
class KCFTracker:
	...
	def init(self, roi, image, init_label):
	...
	def get_tracklets(self): 
		x,y,w,h = self._roi
		# [frame_idx, track_id, label_id, detection_index, x1,y1,x2,y2 ]
		return list([self.age, 0, self.target_label, -1, x,y,x+w-1, y+h-1])