...
class FileHeader():
    ...
    def get_attributes(self):
        ...
        """
        #xinxin return {'description':self.name,'author':self.author,'revMajor':'1','revMinor':'0','date':dt.datetime.now().isoformat()}
        print(dt.date.today())
        return {'description':self.name,'author':self.author,'revMajor':'1','revMinor':'0','date':dt.date.today().isoformat()}
...
class TimeOfDay():
    ...
    def get_attributes(self):
        ...
        """
        #xinxin dt = str(self.year) + '-' + str(self.month) + '-' + str(self.day) + 'T' + str(self.hour) + ':' + str(self.minute) + ':' +str(self.second)
        dt = DT.datetime(self.year, self.month, self.day, self.hour, self.minute, self.second).isoformat()
...
class Environment():
    ...
    def __init__(self, name, timeofday, weather, roadcondition, parameters = None):
    ...
    def get_element(self):
        ...
        """
        #xinxin add name for 'Environment' action
