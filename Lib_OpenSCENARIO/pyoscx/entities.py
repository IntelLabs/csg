...
class Vehicle():
    """ the Vehicle Class creates a Vehicle for openscenario
        ...
        ----------
            ...
            backaxle (Axle): the back axle properties of the vehicle
    ...
    """
    def __init__(self,name, vehicle_type, boundingbox, frontaxle, backaxle, max_speed, max_acceleration, max_deceleration):
        ...
        self.axles = Axles(frontaxle,backaxle)
...
class Axle():
    ...
    #xinxin def get_element(self):
    def get_element(self, attrib_name):
        """ returns the elementTree of the Axle

        """
        #return ET.Element('Axle',attrib=self.get_attributes())
        return ET.Element(attrib_name,attrib=self.get_attributes())
...
class Axles():
    """ the Axles combines the different Axles to one Element
        ...
        ----------
            ...
            backaxle (Axle): Axle properties of the rear axle
    ...
    def __init__(self,frontaxle,backaxle):
        ...
        if not isinstance(backaxle,Axle):
            raise TypeError('backaxle input is not of type Axle')  
    ...
    def get_element(self):
        ...
        #xinxin element.append(self.frontaxle.get_element())
        #xinxin element.append(self.backaxle.get_element())
        element.append(self.frontaxle.get_element('FrontAxle'))
        element.append(self.backaxle.get_element('RearAxle'))
