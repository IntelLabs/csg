...
class ControllerAction(_PrivateActionType):
    ...
    def get_element(self):
        ...
        attr = {'value':str(0),'active':convert_bool(False)}
        attr2 = {'number':str(0),'active':convert_bool(False)}
        ET.SubElement(overrideaction,'Throttle',attr)
        ET.SubElement(overrideaction,'Brake',attr)
        ET.SubElement(overrideaction,'Clutch',attr)
        ET.SubElement(overrideaction,'ParkingBrake',attr)
        ET.SubElement(overrideaction,'SteeringWheel',attr)
        ET.SubElement(overrideaction,'Gear',attr2)
